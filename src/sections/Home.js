  ...
  return (
    // <div  className='w-full h-auto min-h-screen bg-background'>
      ...
      <section name='home' className='max-w-[1000px] mx-auto px-8 md:px-24 lg:px-20 xl:px-0 py-20'>
        ...
        <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6] bg-clip-text text-transparent bg-fixed bg-gradient-to-r from-indigo-500 to-pink-500 hover:from-violet-700 hover:to-red-600 transition-colors duration-300'>Aayush Gakhar</h1>
